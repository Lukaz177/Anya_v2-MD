...
module.exports = {
     ...
     */
    ownername: process.env.Owner_Name || "broken~lukas",
    ownernumber: process.env.Owner_Number || "254111598451",
    ...
    mongoUrl: process.env.MongoDB || "mongodb+srv://Maanka7067:caano1212@cluster0.chanq.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0",
    sessionId: process.env.SESSION_ID || "eTZoMHV_Queen-Anya_tbHI=",
